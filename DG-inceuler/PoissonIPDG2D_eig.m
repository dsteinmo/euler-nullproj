%note, in general may need to fix the 'bc' version of this code to address
%'wall' conditions also.

%same version as used with rao&schwab eigenvalue solver.

function [OP,MM] = PoissonIPDG2D_eig()
