...
for k1=1:K 
  ...
  for f1=1:Nfaces
	...
	OP11        = OP11 + ( mmE*Dy - Dy'*mmE );

	OP12 = zeros(Np);
	OP12(Fm1,:) = OP12(Fm1,:) - (      mmE(Fm1,Fm1)*Dy2(Fm2,:) );  %corresponds to line 71, term 2
	OP12(:,Fm2) = OP12(:,Fm2) - (-Dy'*mmE(:, Fm1) );              %corresponds to line 71, term 3
