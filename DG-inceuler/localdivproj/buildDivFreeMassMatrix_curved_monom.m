...
function [mat,upsi,vpsi] = buildDivFreeMassMatrix_curved_monom(N,x,y,V,cV,cW)
       %V = psi
       %upsi = -Dy*V;
       %vpsi = Dx*V;
       %can use my 'monomials' function if this turns out to be bad.
       [upsi,vpsi] = buildDivFreeMonomials(N,x,y);
       Np = length(V);
       ...
       for ii=1:Npdiv
           for jj=1:Npdiv
               ...
               %original thought (probably would have aliasing errors):
