...
% Cornell University.
   ...
   ptypes = { 'postnormal', 'postnull' };
   fname  = { 'djl_postnormal', 'djl_postnull' };
   ...
   for ii = 1:length(ptypes)
         ...
         for jj = 1:length(tau)
            ...
            % Solve the problem.
            [ux uz rho t] = solve_incompressible_euler( n, mx, mz, x(:), z(:), ux0, uz0, rhoi, rhob(:), dt, t_final, ptypes{ii}, tau(jj) );
            ...
            % Make the filename.
            iifname = [fname{ii} '_tau_index_' num2str(jj) ];
